...
public final class ThrowsWrapping {
    ...
    private static java.util.Optional<Replacement> buildReplacement(
        ...
        ReferenceType lastEx = thrownExceptions.get(thrownExceptions.size() - 1);
        ...
        String methodIndent = extractIndent(lines[callable.getBegin().get().line - 1]);
        ...
        String beforeCloseParen = lines[closeParenLine].substring(0, closeParenCol + 1);
        ...
        String singleLine = beforeCloseParen + " throws " + throwsList + suffix;
